...
class ChunkIoU:
    ...
    """
    def __init__(self, window_sizes, num_chunks, iou, in_name, len_name, dur_name, ts_name, out_names):
        """
    ...
    def __call__(self, data):
        ...
        for jj in range(len(self.window_sizes)):
            ...
            indices_unfolded = indices_unfolded.transpose(1,2).view(B, NW, self.num_chunks[jj], clips_in_chunk) # B NW NC CS
            ...
            time_unit = time_unit.unsqueeze(1).unsqueeze(2).float().repeat(1,NW,self.num_chunks[jj])
