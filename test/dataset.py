...
class TestDatasets(unittest.TestCase):
    ...
    def test_tvrh5(self):
        ...
        vis_h5file = Path("/Users/mohsenmalmir/Downloads/tvr_feature_release/video_feature/tvr_i3d_rgb600_avg_cl-1.5.h5")
        query_h5file = Path("/Users/mohsenmalmir/Downloads/tvr_feature_release/bert_feature/query_only/tvr_query_pretrained_w_query.h5")
        ds = TVRH5(json_file, vis_h5file, query_h5file,transform=[])
